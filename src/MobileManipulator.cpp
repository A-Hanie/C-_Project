...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
MobileManipulator::MobileManipulator(MobileManipulator &copy)
{
    this->name = copy.name;
    this->type = copy.type;
    ...
    this->cameraType = copy.cameraType;
    this->LidarType =copy.LidarType;
    this->no_of_sensors = copy.no_of_sensors;
    this->numberOfWheels = copy.numberOfWheels;
    this->workspace_size = copy.workspace_size;
    this->mobileManipulator_Loc = copy.mobileManipulator_Loc;

    setEndEffectorType( copy.GetEndEffectorType() );
    set_maxReach( copy.getMaxReach() );
    set_payload( copy.getPayload());
    green();
    cout << "Entered custom copy constructor of MobileManipulator object "<< endl<< endl;
    //reset();
}
MobileManipulator::~MobileManipulator()
{
...
{
    yellow();
    cout  <<endl<< "Robot in moving state" << endl<< endl;
    reset();
}
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
{
    yellow();
    cout <<endl<< "Robot picked the Object !!!" << endl<< endl;
    reset();
}
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
